const Table = ({ setViewDetails, setIsEdittingUser, setIsDeletingUser }) => {
  return (
...
const TableRow = ({ setViewDetails, setIsEdittingUser, setIsDeletingUser }) => {
  return (
    <tr>
      <td>
        <img
      ...
      <td className="actions">
        <button
          onClick={() => setIsEdittingUser(true)}
